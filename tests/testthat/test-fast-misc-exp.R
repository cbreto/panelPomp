...
test_that("toVectorPparams and fromVectorPparams work (shared parameters only)", {
  listPparams <-
    list(shared=shared,
...
test_that("toVectorPparams and fromVectorPparams work (specific parameters only)", {
...
test_that("toVectorPparams and fromVectorPparams work (both shared & specific parameters)", {
