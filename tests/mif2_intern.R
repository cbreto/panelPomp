...
mf <- mif2(pPomp.object,Np=10,cooling.type="geometric",cooling.fraction.50=0.5,
           rw.sd=rw.sd(tau=0.02,X.0=ivp(0.2)),transform=TRUE)
...
test("mif2d.ppomp",class(panelPomp:::mif2.internal(
  ...
  Np=50,rw.sd=rw.sd(tau=0.02,X.0=ivp(0.2)),transform=TRUE,
  cooling.type="geometric",cooling.fraction.50=0.5))[1])
...
test(class(try(mif2(pg,Nmif=2,Np=50,rw.sd=rw.sd(something=0.02,random=ivp(0.2)),
              transform=TRUE,cooling.type="geometric",cooling.fraction.50=0.5),
