...
toListPparams <- function(
  ...
  #  u <- 5 # at least 1
  #  specific <- matrix(as.numeric(paste0(rep(seq(
  #    3, u + 2
  #  ), each = 2), rep(
  #    c(".1", ".2"), times = u
  #  ))),
  ...
  #           )
  #    )
  #  #listPparams <- listPparams.specific.only <- list(cool.common = numeric(0), yay.specific = specific)
  #  #listPparams <- listPparams.mixec <- list(cool.common = common, yay.specific = specific)
  #
  #  # FUNCTION ARGUMENTS
  #  vector.position.in.listPparams <-
  #    which(sapply(listPparams, is.vector))
  #  matrix.name.in.listPparams <-
  #    names(listPparams)[ifelse(vector.position.in.listPparams == 1, 2, 1)]
  #  names.in.vector <-
  #    names(listPparams[vector.position.in.listPparams]$cool.common)
  #  vector.name.in.listPparams <-
  #    names(listPparams)[vector.position.in.listPparams]
  #  matrixPparams <- toMatrixPparams(listPparams)
  #}
